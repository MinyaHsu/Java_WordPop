...
public class Game3 implements ActionListener{
	...
	//回到首頁按鈕
	String iconPath_next = "images/回到首頁.png";
	...
	int index = 0;
	int[] keyin = new int[5];
	int[] word = {12, 3, 7, 22, 2};//正確單字DRIVE
	...
	public Game3() {
		...
		jp1.setLayout(null);
		String iconPath_1 = "images/第三關.png";
		...
		//成功視窗
		jf_final.setVisible(false);
		jf_final.setSize(410,680);
		jf_final.setLocation(450,10);
		jf_final.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		jf_final.setTitle("WORD POP");
		
		//成功背景
		JPanel jp_win = new JPanel();
		jp_win.setLayout(null);
		String iconPath_win = "images/闖關成功.png";
